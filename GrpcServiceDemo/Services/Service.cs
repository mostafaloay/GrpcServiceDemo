...
namespace GrpcServiceDemo.Services
{
    public class Service : TestService.TestServiceBase
    {
        ...
        public override async Task<HelloReply> SayClientHellos(IAsyncStreamReader<HelloRequest> requestStream,
            ServerCallContext context)
        {
        ...
        public override async Task BiDirectionalStreaming(IAsyncStreamReader<HelloRequest> requestStream,
            IServerStreamWriter<HelloReply> responseStream, ServerCallContext context)
        {
            while (await requestStream.MoveNext())
            {
                ...
                await responseStream.WriteAsync(new HelloReply()
                {
                    Message = "replay : " + requestStream.Current.Name
                });
            }

            Console.WriteLine("End Streaming.");
        }
    }
}